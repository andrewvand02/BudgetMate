...
const CategoryBreakdown = () => {
    ...
    useEffect(() => {
        const fetchActualExpenses = async () => {
            try {
                ...
                setSelectedWeek(Object.keys(weeklyCategoryExpenses)[Object.keys(weeklyCategoryExpenses).length - 1]); // Select the most recent week
    ...
    const barChartData = {
        ...
        datasets: [{
            ...
            label: `Expenses`, // Dynamic label showing the selected week
    ...
    // Check if there are no expenses data
    const isDataEmpty = Object.keys(actualExpenses).length === 0;

    return (
        <div>
            <div className='dashboard-category-container' style={{maxWidth: '300px'}}>
                {/* Bar chart displaying expenses by category for the most recent week */}
