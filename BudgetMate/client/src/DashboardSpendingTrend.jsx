...
import './DashboardSpendingTrend.css';
...
const SpendingTrend = () => {
    ...
    // Check if there is no chart data
    const isDataEmpty = !lineChartData.labels || lineChartData.labels.length === 0;

    return (
        <div>
            <div className='dashboard-trend-container'>
                {/* Conditionally render the message if no chart data is available */}
                {isDataEmpty ? (
